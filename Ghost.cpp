...
*  Diverts the movement to the coresponding function based on the difficulty chosen by player
*/
void Ghost::move(char board[][terminal_Size_X], GameObject pacmanPos, vector<Ghost> ghosts) {
...
/*----------------------------------------------------------------------------------------------*/
/* Function implements movement using the A* algorithem
